            ...
            <div class="row g-2">
                <div class="col-sm-auto ms-auto">
                    <div class="list-grid-nav hstack gap-1">
                        <a class="btn btn-success" href="{{ route('distributor.create') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="hstack gap-3 flex-wrap">
                                                ...
                                                <a href="{{ route('distributor.show', $distributor->id) }}" class="link-primary fs-15"><i class="ri-eye-line"></i></a>
                                                <form action="{{ route('distributor.destroy', $distributor->id) }}"
                                                    method="POST" id="delete-form-{{ $distributor->id }}"
                                                    style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                                ...
                                                <a href="javascript:void(0);" class="link-danger fs-15"
                                                    onclick="if(confirm('Are you sure you want to delete this distributor?')) { document.getElementById('delete-form-{{ $distributor->id }}').submit(); }">
